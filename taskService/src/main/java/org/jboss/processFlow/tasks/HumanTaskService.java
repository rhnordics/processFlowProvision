...
*/
    ...
    public Group getRoleFromBRMSOrganizationalEntity(String roleId){
        ...
        try {      
            eManager = humanTaskEMF.createEntityManager();
            return eManager.find(Group.class, roleId);
        } finally {
            if(eManager != null)
                eManager.close();
        }
    ...
    public void start() throws Exception {
        ...
        try {
            ...
            dsObj = (DataSource)jndiContext.lookup("java:/global/jbpm-core-cp");
            ...
            // 4) instantiate TaskEventListeners
            ...
            // 5) turn on/off the intelligent human task input/output mapping
